...
const config = {
  ...
  // scripts: [
  //   // String format.
  //   // "https://cdn.jsdelivr.net/npm/codejar@3.2.3/codejar.min.js",
  //   // // Object format.
  //   // {
  //   //   src: "https://cdn.jsdelivr.net/npm/codejar@3.2.3/codejar.min.js",
  //   //   async: true,
  //   // },
  //   {
  //     src: "./postScript.js",
  ...
  // ],
  customFields: {
    postBodyTags: `<% #if (document.getElementsByClassName('language-motoko').length > 0) { %>
  ...
  <html>
    ...
    <script>console.log('scripts is working')</script>
    <script type="text/javascript" src="../postScript.js" defer>console.log('is it working?')</script>
  </html>`,
};

// const plugin = async function (context, options) {
//   return {
