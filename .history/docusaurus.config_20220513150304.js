...
const config = {
    ...
    return {
      headTags: [
        // https://www.wowhead.com/tooltips
        {
          tagName: "script",
          innerHTML: `
            console.log('is this working headtag?)
          `,
        },
        {
          tagName: "script",
  ...
  customFields: {
    postBodyTags1: `<% #if (document.getElementsByClassName('language-motoko').length > 0) { %>
      ...
      <% } %>`,
    postBodyTags: `console.log('hello is this working?!')`,
  },
